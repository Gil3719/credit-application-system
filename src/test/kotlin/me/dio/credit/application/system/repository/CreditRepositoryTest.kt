...
class CreditRepositoryTest {
    ...
    fun `should find credit by credit code`(){
        ...
        Assertions.assertThat(fakeCredit1).isSameAs(fakeCredit1)
        Assertions.assertThat(fakeCredit2).isSameAs(fakeCredit2)
    }
    ...
    private fun buildCredit(
        ...
        dayFirstInstallment: LocalDate = LocalDate.of(2024, Month.MARCH, 22),
